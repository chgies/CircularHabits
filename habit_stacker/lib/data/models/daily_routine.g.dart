...
extension DailyRoutineQueryFilter
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterFilterCondition> nameEqualTo(
    String value, {
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterFilterCondition> orderEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'order',
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterFilterCondition> orderLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterFilterCondition> orderBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension DailyRoutineQuerySortBy
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<DailyRoutine, DailyRoutine, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }

  QueryBuilder<DailyRoutine, DailyRoutine, QAfterSortBy> sortByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }

  QueryBuilder<DailyRoutine, DailyRoutine, QAfterSortBy> sortByOrderDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DailyRoutineQuerySortThenBy
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<DailyRoutine, DailyRoutine, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }

  QueryBuilder<DailyRoutine, DailyRoutine, QAfterSortBy> thenByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }

  QueryBuilder<DailyRoutine, DailyRoutine, QAfterSortBy> thenByOrderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.desc);
    });
  }
...
extension DailyRoutineQueryWhereDistinct
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DailyRoutine, DailyRoutine, QDistinct> distinctByOrder() {
    return QueryBuilder.apply(this, (query) {
...
extension DailyRoutineQueryProperty
  ...
  QueryBuilder<DailyRoutine, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'name');
    });
  }

  QueryBuilder<DailyRoutine, int, QQueryOperations> orderProperty() {
    return QueryBuilder.apply(this, (query) {
